...
import {
    ...
    ViewContainerRef, NgZone, NgModule, Injector
} from "@angular/core";
...
export class TestAppComponent {
    ...
    constructor(
        ...
        registerTestApp(TestAppComponent, this, appRef);
    }
    ...
    public static create(providers?: any[], components: any[] = [], directives: any[] = []): Promise<TestAppComponent> {
        return bootstrapTestApp(TestAppComponent, providers, [], components, directives);
    }
